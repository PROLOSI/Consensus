...
* Consensus is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as Consensus is mean to act as a starting point for Android Applications.

# Consensus App

[![Build Status](https://travis-ci.org/AndroidBootstrap/app-consensus-prolosi-consensusapp.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/app-consensus-prolosi-consensusapp)

This repository contains the source code for the [Consensus](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=app.consensus.prolosi.consensusapp).

Please see the [issues](https://github.app.consensus.prolosi.consensusapp/app-consensus-prolosi-consensusapp/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Consensus? Ask away on the [app-consensus-prolosi-consensusapp discussion forum](https://groups.google.com/forum/#!forum/app-consensus-prolosi-consensusapp).

<a href="https://play.google.com/store/apps/details?id=app.consensus.prolosi.consensusapp" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __app.consensus.prolosi.consensusapp__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____app.consensus.prolosi.consensusapp__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.app.consensus.prolosi.consensusapp.R__) will now be renamed
...
signed with a different key.  Manually uninstall Consensus from your device and
...
Consensus is a result of a template project I've developed over the years as well as
...
Consensus is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.app.consensus.prolosi.consensusapp/app-consensus-prolosi-consensusapp/contributors) on
...
[pull requests](https://github.app.consensus.prolosi.consensusapp/app-consensus-prolosi-consensusapp/pulls).
