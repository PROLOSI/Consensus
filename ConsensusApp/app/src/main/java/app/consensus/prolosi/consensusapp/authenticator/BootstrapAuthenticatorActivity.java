package app.consensus.prolosi.consensusapp.authenticator;
...
import app.consensus.prolosi.consensusapp.BootstrapApplication;
import app.consensus.prolosi.consensusapp.R;
import app.consensus.prolosi.consensusapp.R.id;
import app.consensus.prolosi.consensusapp.R.layout;
import app.consensus.prolosi.consensusapp.R.string;
import app.consensus.prolosi.consensusapp.core.BootstrapService;
import app.consensus.prolosi.consensusapp.core.Constants;
import app.consensus.prolosi.consensusapp.core.User;
import app.consensus.prolosi.consensusapp.events.UnAuthorizedErrorEvent;
import app.consensus.prolosi.consensusapp.ui.TextWatcherAdapter;
import app.consensus.prolosi.consensusapp.util.SafeAsyncTask;
import app.consensus.prolosi.consensusapp.util.Toaster;
