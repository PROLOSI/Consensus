...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "app.consensus.prolosi.consensusapp";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Consensus";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "app.consensus.prolosi.consensusapp.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "app.consensus.prolosi.consensusapp.";
