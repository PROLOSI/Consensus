...
package app.consensus.prolosi.consensusapp.test;
...
import static app.consensus.prolosi.consensusapp.core.Constants.Auth.*;

import app.consensus.prolosi.consensusapp.tests.R;
import app.consensus.prolosi.consensusapp.util.Ln;
